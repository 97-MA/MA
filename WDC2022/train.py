...
wandb.init(project="workshop_highlow",  entity="mawjdgus")
...
real_dataset = train_dataset('/home/data/WDC2022/', args.dataname, 'low_real', transform=transform_train)
...
val_real_dataset = train_dataset('/home/data/WDC2022', args.dataname, 'low_real', transform=transform_train, train=False)

val_data = torch.utils.data.ConcatDataset([val_fake_dataset, val_real_dataset])

train_loader = DataLoader(train_data, args.batch_size, shuffle=True, num_workers=4)
val_loader = DataLoader(val_data, args.batch_size, shuffle=True, num_workers=4)
