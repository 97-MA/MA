...
parser.add_argument('--dataname', default='DeepFake', type=str, help='data name_fake')
parser.add_argument('--fake', default='DeepFake', type=str, help='data name_fake')
parser.add_argument('--real', default='DeepFake', type=str, help='data name_real')
...
test_fake_dataset = train_dataset('/home/data/WDC2022', args.dataname, 'high_fake', transform=transform_train, test=True)
